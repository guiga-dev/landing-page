...
const ServiceCard = ({ service, index, isActive, onHover }) => {
  ...
  return (
    <motion.div
      ...
      className={`group relative rounded-2xl p-8 cursor-pointer transition-colors duration-500 ${
        isActive
          ? 'bg-blue-50 dark:bg-blue-600/10 border-blue-300 dark:border-blue-500/30 shadow-xl shadow-blue-100 dark:shadow-blue-500/10'
    ...
    >
      ...
      {isActive && (
        <motion.div
          ...
          className="absolute inset-0 rounded-2xl bg-gradient-to-br from-blue-100/50 dark:from-blue-500/5 to-transparent"
      ...
      <div className="relative z-10">
        ...
        <div className={`w-14 h-14 rounded-xl flex items-center justify-center mb-6 transition-colors duration-500 ${
          isActive
            ...
            : 'bg-slate-100 dark:bg-white/5 group-hover:bg-blue-100 dark:group-hover:bg-blue-600/20'
        }`}>
          <Icon className={`w-6 h-6 transition-colors duration-500 ${
            isActive ? 'text-white' : 'text-blue-600 dark:text-blue-400 group-hover:text-blue-500 dark:group-hover:text-blue-300'
          }`} />
        </div>
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <ArrowUpRight className={`w-5 h-5 transition-all duration-300 ${
            isActive ? 'text-blue-600 dark:text-blue-400 translate-x-0 translate-y-0' : 'text-slate-300 dark:text-white/20 translate-x-1 translate-y-1'
          }`} />
        </div>
            ...
            >
              {service.features.map((feature, i) => (
                <motion.div
                  ...
                  className="flex items-center gap-2 text-sm text-blue-600 dark:text-blue-300/80"
                >
...
export const ServicesSection = () => {
  ...
  return (
    <section id="servicos" className="relative py-32 bg-white dark:bg-[#030B1A]">
      {/* Subtle top divider */}
